...
public class BajasSistemaTest
{
    ...
    public void testEliminarAlumnoErroneo2()
    {
        try
        {
            this.fixture1.sistema.eliminarAlumno(null);
    ...
    public void testEliminarAsignaturaCorrecto()
    {
        try
        {
            this.fixture1.sistema.eliminarAsignatura(this.fixture1.asignatura1);
        }
        catch (Exception e)
        {
            Assert.fail("Debería haber tenido éxito.");
    ...
    public void testEliminarAsignaturaErroneo2()
    {
        try
        {
            this.fixture1.sistema.eliminarAsignatura(null);
            Assert.fail("No debería haber intentado eliminar un elemento nulo.");
        }
        catch (Exception e)
        {
    ...
    public void testEliminarProfesorCorrectoErroneo2()
    {
        try
        {
            this.fixture1.sistema.eliminarProfesor(null);
            Assert.fail("No debería haber intentado eliminar un elemento nulo.");
        }
        catch (Exception e)
        {
    ...
    public void testEliminarCursadaCorrecto()
    {
        try
        {
            this.fixture1.sistema.eliminarCursada(this.fixture1.cursada);
        }
        catch (Exception e)
        {
            Assert.fail("Debería haber tenido éxito.");
    ...
    public void testEliminarCursadaErroneo2()
    {
        try
        {
            this.fixture1.sistema.eliminarCursada(null);
            Assert.fail("No debería haber intentado eliminar un elemento nulo.");
        }
        catch (Exception e)
        {
